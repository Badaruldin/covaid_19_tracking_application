...
/// active : 22133757
/// critical : 34968
/// casesPerOneMillion : 90386
/// deathsPerOneMillion : 899.2
/// tests : 7026323326
/// testsPerOneMillion : 884377.68
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2785.9
/// recoveredPerOneMillion : 85009.79
/// criticalPerOneMillion : 4.4
/// affectedCountries : 231

class CovaidAllStatesModel {
  CovaidAllStatesModel({
      int? updated, 
      int? cases, 
      int? todayCases, 
      int? deaths, 
  ...
  CovaidAllStatesModel.fromJson(dynamic json) {
...
CovaidAllStatesModel copyWith({  int? updated,
  int? cases,
  int? todayCases,
  int? deaths,
  int? todayDeaths,
  ...
  double? criticalPerOneMillion,
  int? affectedCountries,
}) => CovaidAllStatesModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
